 ...
 * @property \common\models\Event $source
 */
abstract class Subscription extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['service_id', 'rule_id', 'source_id', 'enabled', 'trusted', 'name'], 'required'],
            [['service_id', 'rule_id', 'source_id', 'enabled', 'trusted', 'created_by', 'updated_by'], 'integer'],
    ...
    {
        return $this->hasOne(\common\models\Event::className(), ['id' => 'source_id']);
    }
