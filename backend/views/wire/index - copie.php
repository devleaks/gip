...
<div class="wire container-fluid">
	...
	<div class="row">
		...
		<div class="col-lg-2">
			<div class="row">
				<div class="col-lg-12">
						<div id="cssclock"><div id="clockanalog"><img src="<?=$asset->baseUrl?>/css/css-clocks/analogseconds.png" id="analogsecond" alt="Clock second-hand" /><img src="<?=$asset->baseUrl?>/css/css-clocks/analogminutes.png" id="analogminute" alt="Clock minute-hand" /><img src="<?=$asset->baseUrl?>/css/css-clocks/analoghours.png" id="analoghour"  alt="Clock hour-hand" /></div><div id="clockdigital"><img src="<?=$asset->baseUrl?>/css/css-clocks/digitalhours.gif" id="digitalhour" alt="Clocks hours" /><img src="<?=$asset->baseUrl?>/css/css-clocks/digitalminutes.gif" id="digitalminute" alt="Clocks minutes" /><img src="<?=$asset->baseUrl?>/css/css-clocks/digitalseconds.gif" id="digitalsecond" alt="Clocks seconds" /><div>&nbsp;</div><div>&nbsp;</div></div></div>
