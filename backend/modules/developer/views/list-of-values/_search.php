 ...
 * @var common\models\search\ListOfValues $model
 * @var yii\widgets\ActiveForm $form
 */
?>

<div class="list-of-values-search">
    ...
    <?php // echo $form->field($model, 'value_column_name') ?>

    <?php // echo $form->field($model, 'display_column_name') ?>
